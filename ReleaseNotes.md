...
- Тесты:
  ...
  - **Сделал типизированный `TestMatchers<T>` для проверки результатов тестов. В классах `UserTestData` и `ru.javawebinar.topjava.UserTestData.MealTestData` создаю его инстансы с заданным типом и методикой сравнения.**
