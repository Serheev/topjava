...
public interface CrudMealRepository extends JpaRepository<Meal, Integer> {
    ...
    List<Meal> findAll(@Param("userId") int userId, Sort sortId);
    ...
    List<Meal> findAll(@Param("startDateTime") LocalDateTime startDateTime, @Param("endDateTime") LocalDateTime endDateTime, @Param("userId") int userId, Sort sortId);
}